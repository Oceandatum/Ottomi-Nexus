...
- [1. 产品与商业化 FAQ](#1-产品与商业化-faq)
  - [1.1 Ottomi Nexus 产品核心定位是什么？主要解决哪些业务问题？](#11-ottomi-nexus产品核心定位是什么主要解决哪些业务问题)
  - [1.2 基础版、高级版、集团版核心差异有哪些？](#12-基础版高级版集团版核心差异有哪些)
  - [1.3 基础版永久免费的使用范围与限制是什么？](#13-基础版永久免费的使用范围与限制是什么)
  - [1.4 商业版授权模式、授权类型与使用边界说明](#14-商业版授权模式授权类型与使用边界说明)
  - [1.5 产品开源与闭源边界如何划分？哪些模块会开放源码？](#15-产品开源与闭源边界如何划分哪些模块会开放源码)
  - [1.6 是否支持私有化部署、离线环境、内网隔离使用？](#16-是否支持私有化部署离线环境内网隔离使用)
  - [1.7 不同行业（制造 / 政务 / 金融 / 能源水利等）适配能力如何？](#17-不同行业制造--政务--金融--能源水利等适配能力如何)
  - [1.8 版本升级规则、迭代节奏、更新保障机制](#18-版本升级规则迭代节奏更新保障机制)
  - [1.9 商业售后支持范围、服务响应规则、技术支撑方式](#19-商业售后支持范围服务响应规则技术支撑方式)
  - [1.10 合作对接、定制开发、项目定制化服务是否支持？](#110-合作对接定制开发项目定制化服务是否支持)
- [2. 快速入门 & 基础使用 FAQ](#2-快速入门--基础使用-faq)
  - [2.1 初次上手 Ottomi，整体操作流程是什么？](#21-初次上手-ottomi整体操作流程是什么)
  - [2.2 部署完成后，首次初始化需要做哪些步骤？](#22-部署完成后首次初始化需要做哪些步骤)
  - [2.3 支持哪些类型异构数据源快速接入？](#23-支持哪些类型异构数据源快速接入)
  - [2.4 如何新建项目、数据空间、业务主题目录？](#24-如何新建项目数据空间业务主题目录)
  - [2.5 账号登录、角色权限、团队成员如何配置？](#25-账号登录角色权限团队成员如何配置)
  - [2.6 基础数据同步、数据接入、基础加工如何操作？](#26-基础数据同步数据接入基础加工如何操作)
  - [2.7 页面功能入口找不到、基础操作卡点如何自查？](#27-页面功能入口找不到基础操作卡点如何自查)
  - [2.8 浏览器兼容、前端访问、界面显示异常处理](#28-浏览器兼容前端访问界面显示异常处理)
  - [2.9 基础功能试用建议，新手最简实践步骤](#29-基础功能试用建议新手最简实践步骤)
  - [2.10 日常使用高频注意事项与基础规范](#210-日常使用高频注意事项与基础规范)
  - [2.11 首页全局模块有哪些？业务规划与项目空间是什么关系？项目空间的 Dev-Prod 模式和 Basic 模式有何区别？](#211-首页全局模块有哪些业务规划与项目空间是什么关系项目空间的-dev-prod-模式和-basic-模式有何区别)
- [3. 架构 & 技术集成 FAQ](#3-架构--技术集成-faq)
  - [3.1 Ottomi 整体技术架构、核心组件与设计理念？](#31-ottomi-整体技术架构核心组件与设计理念)
  - [3.2 底层技术栈、依赖中间件、改造集成开源组件说明](#32-底层技术栈依赖中间件改造集成开源组件说明)
  - [3.3 信创环境适配、国产数据库、国产服务器兼容情况](#33-信创环境适配国产数据库国产服务器兼容情况)
  - [3.4 双沙盒机制、RBAC+ABAC 统一权限架构原理](#34-双沙盒机制rbacabac-统一权限架构原理)
  - [3.5 多模态能力、AI 智能中心、知识库能力如何对接？](#35-多模态能力ai-智能中心知识库能力如何对接)
  - [3.6 MCP/API 接口能力、第三方系统集成方式（待开放）](#36-mcpapi-接口能力第三方系统集成方式待开放)
  - [3.7 集群部署、分布式架构、高可用部署方案](#37-集群部署分布式架构高可用部署方案)
  - [3.8 异构数据融合、跨库关联、数仓建模能力说明](#38-异构数据融合跨库关联数仓建模能力说明)
  - [3.9 二次开发扩展方式、自定义组件开发规范](#39-二次开发扩展方式自定义组件开发规范)
  - [3.10 数据安全、隔离策略、敏感数据管控设计](#310-数据安全隔离策略敏感数据管控设计)
  - [3.11 数据质检引擎能力与 DAMA 标准覆盖情况？](#311-数据质检引擎能力与-dama-标准覆盖情况)
  - [3.12 数据资产管理与资产市场的区别与协同？](#312-数据资产管理与资产市场的区别与协同)
  - [3.13 可信数据空间平台是否支持](#313-可信数据空间平台是否支持)
- [4. 运维部署 & 故障排查 FAQ](#4-运维部署--故障排查-faq)
  - [4.1 本地 / 服务器部署环境最低配置要求？](#41-本地--服务器部署环境最低配置要求)
  - [4.2 安装启动失败、端口占用、依赖缺失如何解决？](#42-安装启动失败端口占用依赖缺失如何解决)
  - [4.3 服务启停、日志查看、运行状态监控方法](#43-服务启停日志查看运行状态监控方法)
  - [4.4 数据同步失败、连接超时、数据源连通性排查](#44-数据同步失败连接超时数据源连通性排查)
  - [4.5 版本迁移、环境迁移、数据备份与恢复方案](#45-版本迁移环境迁移数据备份与恢复方案)
  - [4.6 系统卡顿、性能负载、资源占用优化建议](#46-系统卡顿性能负载资源占用优化建议)
  - [4.7 容器化部署、Docker 相关问题处理](#47-容器化部署docker-相关问题处理)
  - [4.8 安全加固、端口防护、访问白名单配置](#48-安全加固端口防护访问白名单配置)
  - [4.9 升级失败、补丁更新、配置文件兼容问题](#49-升级失败补丁更新配置文件兼容问题)
  - [4.10 常见报错码、异常提示快速排查方案](#410-常见报错码异常提示快速排查方案)
  - [4.11 运维管理系统](#411-运维管理系统)
- [5. 选型决策 & 通用问答 FAQ](#5-选型决策--通用问答-faq)
  - [5.1 Ottomi Nexus 与 Apache SeaTunnel / DataHub / DolphinScheduler 等开源工具单独拼装的系统有什么区别？](#51-ottomi-nexus-与-用apache-seatunnel--datahub--dolphinscheduler-等开源工具单独拼装的系统有什么区别)
  - [5.2 基础版免费，功能真的没有阉割吗？会不会用了之后发现关键功能需要付费？](#52-基础版免费功能真的没有阉割吗会不会用了之后发现关键功能需要付费)
  - [5.3 没有专门的数仓或大数据团队，能用 Ottomi Nexus 吗？](#53-没有专门的数仓或大数据团队能用-ottomi-nexus-吗)
  - [5.4 部署 Ottomi Nexus 需要什么样的技术背景？是否需要专业的运维人员？](#54-部署-ottomi-nexus-需要什么样的技术背景是否需要专业的运维人员)
  - [5.5 Ottomi Nexus 支持哪些操作系统？能在 Windows 或 macOS 上安装吗？](#55-ottomi-nexus-支持哪些操作系统能在-windows-或-macos-上安装吗)
  - [5.6 安装包从哪里下载？GitHub 上有安装包吗？](#56-安装包从哪里下载github-上有安装包吗)
  - [5.7 DataHub 是什么？为什么安装 Ottomi Nexus 前需要先安装 DataHub？](#57-datahub-是什么为什么安装-ottomi-nexus-前需要先安装-datahub)
  - [5.8 安装 Ottomi Nexus 需要联网吗？内网环境完全无网能装吗？](#58-安装-ottomi-nexus-需要联网吗内网环境完全无网能装吗)
  - [5.9 基础版和商业版用的是同一个安装包吗？升级商业版需要重新安装吗？](#59-基础版和商业版用的是同一个安装包吗升级商业版需要重新安装吗)
  - [5.10 AI 智能辅助功能需要额外配置什么？免费用户能用吗？](#510-ai-智能辅助功能需要额外配置什么免费用户能用吗)
  - [5.11 Ottomi Nexus 支持实时数据处理吗？还是只能做离线批处理？](#511-ottomi-nexus-支持实时数据处理吗还是只能做离线批处理)
  - [5.12 平台的 BI 分析能力是什么水平？能替代专业的 BI 工具吗？](#512-平台的-bi-分析能力是什么水平能替代专业的-bi-工具吗)
  - [5.13 多语言版本支持情况如何？海外团队可以使用吗？](#513-多语言版本支持情况如何海外团队可以使用吗)
  - [5.14 基础版的数据会锁定吗？如果用了一段时间想升级到商业版，原有数据能保留吗？](#514-基础版的数据会锁定吗如果用了一段时间想升级到商业版原有数据能保留吗)
  - [5.15 如果基础版的资源限制不够用，能否单独购买某个维度的扩容？](#515-如果基础版的资源限制不够用能否单独购买某个维度的扩容)
  - [5.16 Ottomi Nexus 与传统商业数据中台产品相比有什么优势？](#516-ottomi-nexus-与传统商业数据中台产品相比有什么优势)
  - [5.17 平台更新迭代频繁吗？基础版用户能否及时获取新功能？](#517-平台更新迭代频繁吗基础版用户能否及时获取新功能)
  - [5.18 数据迁移成本高不高？从其他数据平台切换到 Ottomi Nexus 复杂吗？](#518-数据迁移成本高不高从其他数据平台切换到-ottomi-nexus-复杂吗)
  - [5.19 基础版用户的数据安全有保障吗？产品本身有没有数据采集或回传行为？](#519-基础版用户的数据安全有保障吗产品本身有没有数据采集或回传行为)
  - [5.20 如何快速验证 Ottomi Nexus 是否适合我们？有没有演示环境可以体验？](#520-如何快速验证-ottomi-nexus-是否适合我们有没有演示环境可以体验)
  - [5.21 产品在信创环境下的实际运行情况如何？有哪些成功案例？](#521-产品在信创环境下的实际运行情况如何有哪些成功案例)
  - [5.22 是否支持 Kubernetes (K8s) 部署？](#522-是否支持-kubernetes-k8s-部署)
  - [5.23 Docker 镜像源配置需要注意什么？国内网络拉取镜像失败怎么办？](#523-docker-镜像源配置需要注意什么国内网络拉取镜像失败怎么办)
  - [5.24 默认管理员账号密码是什么？部署后必须修改吗？](#524-默认管理员账号密码是什么部署后必须修改吗)
  - [5.25 内置的 Demo 项目包含哪些内容？能帮助我了解平台哪些功能？](#525-内置的-demo-项目包含哪些内容能帮助我了解平台哪些功能)
- [6. 官方联系方式](#6-官方联系方式)
